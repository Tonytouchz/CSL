...
&nbsp;<asp:DropDownList ID="ddlAnneeNaissance" runat="server" ValidationGroup="creerCompte" 
    ...
    <p>
        Informations sur l&#39;authentification au site</p>
    <table style="width: 100%">
        <tr>
            <td style="width: 210px">
    ...
    <p>
        <asp:Button ID="btnModifierInfo" runat="server" Text="Modifier les informations" 
            ValidationGroup="creerCompte" />

        <asp:Button ID="btnReinitialiser" runat="server" Text="Réinitialiser" />
        <asp:Button ID="BtnAjoutClient" runat="server" 
