...
Partial Class OublierMotPasse
    ...
    Protected Sub btnEnvoyer_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEnvoyer.Click
        ...
        Dim emailUtilisateur As String = (From Model In leContexte.dossiersJeu Where (Model.username = txtUtilisateur.Text) Select Model.email).First
        Dim motPasseOublie As String = (From Model In leContexte.dossiersJeu Where (Model.username = txtUtilisateur.Text) Select Model.password).First
        ...
        mail.Body = "Bonjour votre mot de passe est: " + motPasseOublie
